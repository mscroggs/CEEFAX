...
class TestPage(Page):
    ...
    def generate_content(self):
        from ceefax.cupt.cupt import curses_colors
        self.add_rainbow_text(config.NAME + " v" + config.LIB_VERSION)
        self.add_newline()
        self.add_newline()
        ...
        self.add_text(config.NAME + " has been running since"
                      " " + Ceefax().start_time.strftime("%y-%m-%d %H:%M"))
